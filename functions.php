...
function bat_customizer_product_data_fields() {
    ...
    <div id="bat_customizer_product_data" class="panel woocommerce_options_panel" style="padding:20px 15px;">
        ...
        <div class="options_group" style="border-bottom:2px solid #f1f1f1; padding-bottom:15px; margin-bottom:25px;">
         ...
         <div class="options_group" style="border-bottom:2px solid #f1f1f1; padding-bottom:15px; margin-bottom:25px;">
            <h3 style="font-size:15px; font-weight:600; margin-bottom:10px;">Weight Selection </h3>
            <?php
            woocommerce_wp_checkbox(array(
...
add_action('wp_insert_post', 'bat_set_defaults_on_product_creation', 10, 3);
function bat_set_defaults_on_product_creation($post_id, $post, $update) {
    ...
    if (get_post_meta($post_id, '_bat_customizer_initialized', true) === 'yes') {
        return;
    }
    ...
    // Enable Weight Selection by default
...
if ($enable_weight === 'yes') {
    ...
    echo '<h3 style="font-size:18px; font-weight:600; margin-bottom:15px; color:#333;">Weight Selection </h3>';
    ...
    echo '<div class="customizer-section" data-group="' . esc_attr($key) . '" style="margin-bottom:6px; border-radius:8px; ' . ($is_enabled ? '' : 'display:none;') . '">';
